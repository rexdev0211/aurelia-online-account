export module CRAApi {
  ...
  export class RiskAnswer implements IRiskAnswer {
    ...
    public constructor(init?: Partial<RiskAnswer>) { (Object as any).assign(this, init); }
  }
  ...
  export class RiskFactor implements IRiskFactor {
    ...
    public overrideScore?: number;
    public overrideWeight?: number;
    public constructor(init?: Partial<RiskFactor>) { (Object as any).assign(this, init); }
  }
  ...
  export class RiskComponent implements IRiskComponent {
    ...
    public weight?: number;
    public overrideWeight?: number;
    public constructor(init?: Partial<RiskComponent>) { (Object as any).assign(this, init); }
  }
  export class RiskCategory implements IRiskCategory {
    ...
    public calcOverrideScore?: number;
    public calculatedScore: number;
    public constructor(init?: Partial<RiskCategory>) { (Object as any).assign(this, init); }
  }
  ...
  export class CRAModel extends RiskModel implements ICRAModel {
    public calculatedScore?: number;
    public constructor(init?: Partial<CRAModel>) { super(init); (Object as any).assign(this, init); }
  }
  export class CRAProfileRecord implements ICRAProfile {
    ...
    public constructor(init?: Partial<CRAProfileRecord>) { (Object as any).assign(this, init); }
  }
  // DTOS
  ...
  export class CRAProfileResponse {
    ...
    public constructor(init?: Partial<CRAProfileResponse>) { (Object as any).assign(this, init); }
  }
  ...
  {
    public constructor(init?: Partial<CRAProfileRequest>) { super(init); (Object as any).assign(this, init); }
    public getTypeName() { return 'CRAProfileRequest'; }
    public getMethod() { return 'GET'; }
    public createResponse() { return new CRAProfileResponse(); }
  }
}
